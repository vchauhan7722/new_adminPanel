...
import {getMyLikesList} from '../../../../../../API/api-endpoint'
...
const MyLikesList = ({handleChange}) => {
  ...
  useEffect(() => {
    getAllMyLikesList(page, pageSize)
  }, [])

  const getAllMyLikesList = async (page: any, pageSize: any) => {
    let result = await getMyLikesList(userId, page, pageSize)
    setMyLikesList(result.data)
          ...
          <div className='table-responsive'>
            ...
            >
              ...
              <tbody className='text-gray-600 '>
                {myLikesList !== undefined &&
                  myLikesList.map((item: any, index: any) => {
                    return (
                      <tr key={index}>
                        <td>
